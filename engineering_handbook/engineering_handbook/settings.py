...
INSTALLED_APPS = [
    ...
    'engineering_handbook.apps.language',
...
ROOT_URLCONF = 'engineering_handbook.urls'
...
WSGI_APPLICATION = 'engineering_handbook.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': BASE_DIR / 'engineering_handbook.sqlite3',
    }
}
