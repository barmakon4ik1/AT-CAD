# at_window_utils.py
"""
Модуль с общими функциями и базовым классом для диалоговых окон ввода параметров.

Содержит утилиты для работы с файлами конфигурации, локализацией, AutoCAD и базовый класс для создания
диалоговых окон с унифицированным интерфейсом и поведением.
"""
import os
...
from at_config import FONT_NAME, FONT_SIZE, FONT_TYPE, BACKGROUND_COLOR
...
def load_last_input(filename: str) -> Dict:
    ...
    Args:
        filename: Имя файла для загрузки (например, 'last_shell_input.json').
